...
# App title and intro
st.title("ICHcal Risk Score Calculator for AMI-CS")
st.markdown("Use the ICHcal risk score to estimate intracranial hemorrhage (ICH) risk in patients with acute myocardial infarction complicated by cardiogenic shock (AMI-CS).")
